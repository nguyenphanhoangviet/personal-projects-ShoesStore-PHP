        ...
        <div class="page-content">
            ...
            <div class="records table-responsive">
                ...
                <div class="record-header">
                    <div class="add">
                        <a href="insert/insert_user.php" class="btn1">Insert</a>
                    </div>
                <!-- ////////// -->
                    <div class="browse">
                    ...
                    <table width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><span class="las la-sort"></span> NAME/EMAIL</th>
                                <th><span class="las la-sort"></span> PASS</th>
                                <th><span class="las la-sort"></span> PHONE</th>
                                <th><span class="las la-sort"></span> ROLE_ID</th>
                            </tr>
                        </thead>
                        <!-- //// -->
                        <?php
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="client">
                                            ...
                                            <div class="client-info">
                                                ...
                                                <small><?php echo $row['user_email'] ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td><a href="../controller/user/delete.php?user_id=<?php echo $row['user_id'] ?>">DELETE</a></td>
                                    <td><a href="update/update_user.php?user_id=<?php echo $row['user_id'] ?>">UPDATE</a></td>
                                </tr>
                            <?php } ?>
                            <!-- <tr>
                                    <td>#5033</td>
